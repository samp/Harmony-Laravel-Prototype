                ...
                <div class="p-2 text-xl text-gray-700">
                    ...
                    @foreach($genres as $genre)
                        @if($genre == $selectedgenre)
                            <div class="rounded-md border-2 hover:border-purple-400 hover:bg-white bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-500 text-white border-transparent transition-colors">
                                <a href="?genre=" class="flex flex-row align-middle p-2"><span class="m-auto">{{ $genre }}</span></a>
                            </div>
                        @else
                            <div class="bg-white rounded-md border-2 border-purple-400 bg-gradient-to-tr hover:from-yellow-400 hover:via-pink-500 hover:to-purple-500 hover:text-white hover:border-transparent transition-colors">
                                <a href="?genre={{ $genre }}" class="flex flex-row align-middle p-2"><span class="m-auto">{{ $genre }}</span></a>
                            </div>
                        @endif
                    @endforeach
