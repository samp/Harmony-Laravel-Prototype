    ...
    <x-card class="flex-col sm:flex-row">
        ...
        <div class="flex flex-col md:w-2/3 p-6">
            <div class="flex flex-col text-lg mb-6">
                <h1 class="text-3xl mb-2 font-medium font-poppins">
                    {{ $itemlisting->name }}
                </h1>
            ...
            <div class="flex flex-col h-full">
                ...
                <div class="flex flex-row justify-between">
                    ...
                    <form action="/cart/add/merch/{{ $itemlisting->id }}" method="POST">
                        ...
                        <select name="size" id="size" class="rounded-lg shadow border-gray-300 dark:border-transparent dark:bg-truegray-600 dark:placeholder-truegray-100 text-sm"">
                ...
                <h5 class="mt-auto ml-auto text-lg font-poppins py-2">{{ formatmoney($itemlisting->price) }}</h5>
