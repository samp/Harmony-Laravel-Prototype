...
class EventSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('events')->insert([
            ...
            'time' => \Carbon\Carbon::parse('2021-08-26'),
        ...
        DB::table('events')->insert([
            ...
            'name' => "Melodrama tour",
            'artist' => "Lorde",
            'time' => \Carbon\Carbon::parse('2021-09-01'),
        ...
        DB::table('events')->insert([
            ...
            'artist' => "McFly",
            'time' => \Carbon\Carbon::parse('2021-05-16'),
        ...
        DB::table('events')->insert([
            ...
            'artist' => "Scooter",
            'time' => \Carbon\Carbon::parse('2021-05-01'),
        ...
        DB::table('events')->insert([
            ...
            'time' => \Carbon\Carbon::parse('2021-06-06'),
        ...
        DB::table('events')->insert([
            ...
            'time' => \Carbon\Carbon::parse('2021-07-13'),
